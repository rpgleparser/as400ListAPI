...
/**
 * This is the main workhorse class for calling the QUSLRCD API. Example of
...
public class QUSLRCD implements ListApiCallback {
	...
	protected void prepareProgramCall() throws PropertyVetoException {
		...
		parameterList[1] = new ProgramParameter(
				formatName.toBytes(requestedFormat));
		...
		parameterList[3] = new ProgramParameter(
				overrideProcessing.toBytes(toOverride));
	...
	/**
	 * @param overrideProcessing
	 *            the overrideProcessing to set
	 */
	...
	/**
	 * @param requestOverrideProcessing
	 *            the requestOverrideProcessing to set
	 */
	...
	/**
	 * @param searchLibrayName
	 *            the searchLibrayName to set
	 */
