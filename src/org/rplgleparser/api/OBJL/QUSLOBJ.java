...
public class QUSLOBJ implements ListApiCallback {
	...
	/**
	 * @param searchObjectName the searchObjectName to set
	 */
	...
	/**
	 * @param searchObjectLibrary the searchObjectLibrary to set
	 */
	...
	/**
	 * @param searchObjectType the searchObjectType to set
	 */
